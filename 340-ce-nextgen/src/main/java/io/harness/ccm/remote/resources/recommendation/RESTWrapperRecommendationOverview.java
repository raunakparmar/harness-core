...
@Service
@OwnedBy(CE)
@Tag(name = "Cloud Cost Recommendations Overview",
    description = "Get Cloud Cost Recommendations for Kubernetes Workloads and Node Pools.")
...
public class RESTWrapperRecommendationOverview {
  ...
  @Operation(operationId = "listRecommendations",
      description = "List Cloud Cost Recommendations for a particular filter.", summary = "List Recommendations",
      responses =
      {
  ...
  @Operation(operationId = "recommendationStats", description = "Cloud Cost Recommendations statistics",
  ...
  @Operation(operationId = "recommendationsCount",
      description = "Count Cloud Cost Recommendations for a particular filter.", summary = "Recommendations count",
      responses =
      {
        @io.swagger.v3.oas.annotations.responses.
  ...
  @Operation(operationId = "recommendationFilterValues", description = "Count Cloud Cost Recommendation filter values.",
      summary = "Recommendations filter values",
      responses =
      {
        @io.swagger.v3.oas.annotations.responses.
